...
public class Scenario7 extends BaseClass
{
	WebDriver driver;
	ITestResult result;
	PropertyReader read;
	String scenarioInfo = ScenarioConfigPaths.SCENARIO_7;
	...
	{
		taxDeclarationPage.clickSelectButton(5)
						  .entityHasUSControllingPerson(false)
